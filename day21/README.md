...
在 [Day14](https://github.com/Jim876633/ithome-2023/tree/main/day14) 有提到串接 API 使用 @tanstack/react-query 來管理狀態，而在 redux toolkit 也有提供 redux toolkit query 來管理狀態，這邊就來看一下如何使用 redux toolkit query 來測試。

這邊建一個可以增減項目並隨時更新的 itemList，並使用 MSW 來模擬 API 的回傳。

![itemListPage](/img/day21-1.gif)
